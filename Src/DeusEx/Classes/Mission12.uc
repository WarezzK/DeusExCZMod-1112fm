...
function FirstFrame()
{
	...
	else if (localURL == "12_VANDENBERG_GAS")
	{
		...
		if(!flags.GetBool('M12_20MMHE_Placed'))
		{
			if(spawn(class'Ammo20mm',None,, vect(-2890,1116,-936.00)) != None)
				flags.SetBool('M12_20MMHE_Placed',True);
		}
	}
	...
	else if (localURL == "12_VANDENBERG_COMPUTER")
	{
		...
		{
			if (M.Name == 'DeusExMover11' || M.Name == 'DeusExMover12')
				M.KeyIDNeeded = 'control_room';
		}
	}
}
