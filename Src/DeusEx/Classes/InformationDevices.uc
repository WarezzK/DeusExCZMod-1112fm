...
function Tick(float deltaTime)
{
	...
	if(bPushable != Default.bPushable && DeusExPlayer(Base) == None && (infoWindow == None || !infoWindow.isVisible()) && (imageClass != None || textTag != '' || specialText != ""))
	{
		//a: added because we can now get rid of info windows by simply pressing ESC.
		if (infoWindow != None)
		DestroyWindow();
