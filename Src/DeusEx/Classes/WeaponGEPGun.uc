...
{
	// Default: PlayerViewOffset = (X=46.000000,Y=-22.000000,Z=-10.000000)
	// Default: FireOffset       = (X=-46.000000,Y=22.000000,Z=10.000000)
	
	if (DeusExPlayer(GetPlayerPawn()) != None)
	{
		if (PickupViewMesh == Default.PickupViewMesh && DeusExPlayer(GetPlayerPawn()).NanoMod.gepGunViewFix)
		{
				Default.PlayerViewOffset.Y = -25.000000;
				Default.FireOffset.Y 	   = 26.000000;
		}
		
		else
		{
			Default.PlayerViewOffset.Y = -22.000000;
			Default.FireOffset.Y 	   = 22.000000;
		}
	}
