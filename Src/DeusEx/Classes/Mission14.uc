...
function FirstFrame()
{
	...
	if (localURL == "14_OCEANLAB_LAB")
	{
		...
		{
			if (M.Name == 'DeusExMover48' || M.Name == 'DeusExMover54' || M.Name == 'DeusExMover64')
				M.KeyIDNeeded = 'OLstorage';
		}
	}
	...
	else if (localURL == "14_OCEANLAB_UC")
	{
		...
		{
			if (dCube.textTag == '14_Datacube03')
			{
				dCube.setLocation(vect(168.0, 7020.0,  -4222.5));
