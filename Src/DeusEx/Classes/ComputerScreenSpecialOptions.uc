...
function CreateOptionButtons()
{
	...
	{
		if ((Computers(compOwner).specialOptions[specialIndex].userName == "") || (Caps(Computers(compOwner).specialOptions[specialIndex].userName) == Caps(winTerm.GetUserName())))
		{
...
function ChangeAccount()
{
	...
	if (winTerm.AreSpecialOptionsAvailable(true))
	CloseScreen("SPECIAL");
	
	else
	{
		if (winTerm.IsA('NetworkTerminalSecurity'))
		CloseScreen("LOGIN");
