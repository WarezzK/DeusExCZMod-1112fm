...
//	version.SetText(player.GetDeusExVersion());
	version.SetText("NanoMod" @ player.NanoMod.currentVersion @ "(+Shifter 1.9 +BioMod 1.1)");
}
...
defaultproperties
{
     ...
     ButtonNames(4)="NanoMod"
     ButtonNames(5)="Training"
     ButtonNames(6)="Challenges"
     ...
     buttonDefaults(4)=(Y=157,Invoke=Class'DeusEx.NanoModSettingsMenu')
     buttonDefaults(5)=(Y=193,Action=MA_Training)
     buttonDefaults(6)=(Y=229,Action=MA_Challenges)
